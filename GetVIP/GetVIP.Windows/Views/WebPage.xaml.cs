...
namespace GetVIP.Views
{
    ...
    public sealed partial class WebPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            JYAnalytics.TrackPageStart("Web_Page");
        ...
        protected override void OnNavigatedFrom(NavigationEventArgs e)
        {
            ...
            JYAnalytics.TrackPageEnd("Web_Page");
        }
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            switch (Menu.name)
            {
                ...
                //会员体验活动
                case "Sales": WebSite.Navigate(new Uri("http://moreplay.cn/getvip/Sales/index.html")); break;
                    //下载破解百度云
                case "PJBaidu": WebSite.Navigate(new Uri("http://moreplay.cn/getvip/PJBaidu/index.html")); break;
                    //下载破解迅雷
                case "PJThunder": WebSite.Navigate(new Uri("http://moreplay.cn/getvip/PJThunder/index.html")); break;
                    //下载破解播放器
                case "PJPlayer": WebSite.Navigate(new Uri("http://moreplay.cn/getvip/PJPlayer/index.html")); break;
        ...
        int i = 0;
        private void adwv_LoadCompleted(object sender, NavigationEventArgs e)
        {
            if (i == 0)
            {
                adwv.Refresh();
